      ...
      <div className={switchToggled ? "dark" : "scene"}>
        ...
        <section className="scene">
          ...
          <div className="bg">
            ...
            <img src="https://raw.githubusercontent.com/panditamey/clock-light-dark-js/main/bike2.png" alt="" className="car1" />
            <img src="https://raw.githubusercontent.com/panditamey/clock-light-dark-js/main/car1.png" alt="" className="car2" />
